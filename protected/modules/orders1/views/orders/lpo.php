...
<body>
	...
	<div id="page-wrap">
		...
		<span id="header">TRIBELI LTD PURCHASE ORDER</span>
		<br  /><br  />
		<div id="identity">
...
website: <?php echo $model->supplier->HomePage; ?>
		...
		<div id="customer">
            ...
            <table id="meta">
                ...
                <tr>
                    ...
                    <td><div class="due">&#8358;<?php  echo $model->TotalPrice; ?></div></td>
                </tr>
		...
		<table id="items">
          ...
          <td><div class="delete-wpr"><?php echo $product->product->Id; ?><!--<a class="delete" href="javascript:;" title="Remove row">X</a>--></div></td>
		      ...
		      <td ><?php echo $product->product->UnitsPerCarton; ?></td>
		      <td>&#8358;<?php echo $product->product->UnitPrice;?></td>
              <td>&#8358;<?php echo $product->product->PackPrice;?></td>
		      <td><?php echo $product->Quantity;?></td>
		      <td><span class="price">&#8358;<?php echo $product->LineTotal;?></span></td>
		  </tr>
		  <?php endforeach; ?>
		<!--  <tr class="item-row">
		  ...
		  <tr>
		      ...
		      <td class="total-line"><div id="total">&#8358;<?php echo $model->TotalPrice;?></div></td>
		  </tr>
		  <!--<tr>
		      <td colspan="2" class="blank"> </td>
		...
		<div id="terms">
		  <h5>Terms</h5>
		 <span> NET 30 Days. Finance Charge of 1.5% will be made on unpaid balances after 30 days.</span><br /><br />
