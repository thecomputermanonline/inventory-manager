...
//$this->menu=array(
//	array('label'=>'List ProductCategories','url'=>array('index'), 'icon'=>'list'),
//	array('label'=>'Manage ProductCategories','url'=>array('admin'), 'icon'=>'cog'),
//);
?>
   ...
   <div class="span7">
    <div class="aqua-panel">
        <div class="aqua-panel-header">
            ...
            <h2>Create ProductCategories<span></span></h2>
